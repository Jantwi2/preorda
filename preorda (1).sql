...
--
-- Host: localhost:8889
-- Generation Time: Apr 02, 2026 at 01:07 PM
...
INSERT INTO `customers` (`customer_id`, `user_id`, `mobile_money_account`) VALUES
(2, 34, NULL);
...
INSERT INTO `orders` (`order_id`, `customer_id`, `vendor_id`, `total_price`, `status`, `shipping_address`, `billing_address`, `order_notes`, `order_date`, `estimated_delivery_date`, `tracking_number`) VALUES
(9, 2, 18, 50.08, 'confirmed', 'Doboro Road, Doboro', '', '', '2026-03-29 14:21:36', NULL, NULL),
(10, 2, 18, 50.08, 'shipped', 'Doboro Road, Doboro', '', '', '2026-03-29 14:48:28', NULL, NULL);
...
INSERT INTO `order_details` (`detail_id`, `order_id`, `product_id`, `quantity`, `unit_price`, `subtotal`) VALUES
(16, 9, 3, 2, 0.04, 0.08),
(17, 10, 3, 2, 0.04, 0.08);
...
(3, 9, 50.08, 'bank_card', 'T558827927148349-9', 'completed', '2026-03-29 14:21:36'),
(4, 10, 50.08, 'bank_card', 'T728998597163627-10', 'completed', '2026-03-29 14:48:28');
...
INSERT INTO `products` (`product_id`, `vendor_id`, `name`, `description`, `price`, `category_id`, `brand_id`, `estimated_delivery_time`, `image_url`, `stock_status`, `created_at`) VALUES
(3, 18, 'Mona Lisa', 'Good better best\r\n', 0.04, 3, 1, 4, '../uploads/products/prod_1774787196_69c91a7c2f0d8.jpg', 'available', '2026-03-29 12:26:36');
...
CREATE TABLE `users` (
  ...
  `address` text,
  `user_type` enum('customer','vendor','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `users` (`user_id`, `full_name`, `email`, `phone`, `password_hash`, `address`, `user_type`, `created_at`, `updated_at`, `is_active`) VALUES
(32, 'Henry Owusu', 'henryowusu022@gmail.com', '+233246110694', '$2y$10$G7IPM8FomLSR.IAQ/WclIeS9ml/eZOFvEe3G9b5p08viwrndcvDIC', ', ', 'vendor', '2025-11-28 02:35:54', '2025-11-28 02:35:54', 1),
(34, 'Yoshio Merrill', 'henryowusu360@gmail.com', '+233246110691', '$2y$10$aScIMZJjru3fQVHTGkZGZ.mSHhJXcMHrTbmuoD6YYqCG94Pmzj7Lq', ', ', 'vendor', '2025-11-28 02:43:26', '2025-11-28 02:43:26', 1),
(36, 'admin', 'admin@gmail.com', '+233246110609', '$2y$10$mLtEZ2.uPg/o0S5oSqV9Be8gCE/ZrHGP7kdH16wN5s.zAWQLV7eFW', ', ', 'admin', '2025-11-28 03:30:54', '2025-11-28 03:33:55', 1),
(39, 'Henry Owusu', 'henryowusu023@gmail.com', '+233246110696', '$2y$10$8VS29IeBcTTtuLwQOOmiWOTm1yib8zgV57XLnuQN2xUeiQmF5D/1W', ', ', 'vendor', '2026-03-29 11:47:01', '2026-03-29 11:47:01', 1);
...
CREATE TABLE `vendors` (
  ...
  `vendor_slug` varchar(255) DEFAULT NULL,
  ...
  `accent_color` varchar(7) DEFAULT '#f7fafc',
...
INSERT INTO `vendors` (`vendor_id`, `user_id`, `business_name`, `registration_number`, `mobile_money_account`, `verified`, `otp`, `otp_expiry`, `email_verified`, `vendor_slug`, `tagline`, `description`, `logo_url`, `primary_color`, `secondary_color`, `background_color`, `header_color`, `accent_color`, `font_family`) VALUES
(16, 34, 'Try Store', '', '', 1, NULL, NULL, 0, NULL, NULL, NULL, NULL, '#3182ce', '#2d3748', '#ffffff', '#000000', '#f7fafc', 'Inter'),
(18, 39, 'Capstone', '', '', 1, NULL, NULL, 0, 'capstone', '', '', '', '#cf3058', '#1264f3', '#f7f7f7', '#050505', '#1d84c9', 'Inter');
...
ALTER TABLE `vendors`
  ...
  ADD UNIQUE KEY `vendor_slug` (`vendor_slug`),
  ADD KEY `user_id` (`user_id`),
...
--
ALTER TABLE `vendors`
  MODIFY `vendor_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
ALTER TABLE `chats`
  ...
  ADD CONSTRAINT `chats_ibfk_3` FOREIGN KEY (`receiver_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `chats_ibfk_4` FOREIGN KEY (`sender_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
ALTER TABLE `disputes`
  ...
  ADD CONSTRAINT `disputes_ibfk_3` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`vendor_id`) ON DELETE CASCADE;
