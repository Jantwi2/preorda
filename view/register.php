...
<body>
  ...
  <div class="left-panel">
    ...
    <div class="feat-list">
      <div class="feat-row">
        ...
        <div class="feat-text">
          ...
          <p>Share https://lightgoldenrodyellow-dove-201674.hostingersite.com/your-store on any platform</p>
        </div>
      </div>
      <div class="feat-row">
    ...
    <div class="preview-card">
      ...
      <div class="preview-url">https://lightgoldenrodyellow-dove-201674.hostingersite.com/view/products.php?store=<span id="livePreviewSlug">your-store</span></div>
      ...
      <form id="signupForm" novalidate>
        ...
        <div class="field">
          ...
          <div class="url-preview-strip" id="urlPreview">
            <span class="url-domain">https://lightgoldenrodyellow-dove-201674.hostingersite.com/view/products.php?store=</span><span class="url-slug" id="urlSlug">your-store</span>
...
<script>
  ...
  // ── COPY URL
  function copyUrl() {
    const url = `https://lightgoldenrodyellow-dove-201674.hostingersite.com/view/products.php?store=${slugEl.textContent}`;
